...
cheribuildProject(target: 'llvm-native', architecture: 'native',
        ...
        afterTests: {
            ...
            // This is needed for the FreeBSD build since the recordIssues()
            // step chokes on the non-ASCII file names produced by some tests
            // FIXME: We should fix the FreeBSD build servers, but cleaning the
